...
class PipeliningBatchSerialSeqRecomputationTest(test_util.TensorFlowTestCase):
  ...
  def testPipelineCompare1(self):
    ...
    pipelining_test_util.PipelineTester.compare_pipeline_to_cpu(
        ...
        gradient_accumulation_count, dataset_fn, optimizer_fn, self, 19714,
  ...
  def testPipelineCompare2(self):
    ...
    pipelining_test_util.PipelineTester.compare_pipeline_to_sharding(
        ...
        gradient_accumulation_count, dataset_fn, optimizer_fn, self, 199241,
        True, pipelining_ops.PipelineSchedule.Sequential)
  ...
  def testPipelineCompare3(self):
    ...
    pipelining_test_util.PipelineTester.compare_pipeline_to_cpu(
        ...
        gradient_accumulation_count, dataset_fn, optimizer_fn, self, 60107,
        True, pipelining_ops.PipelineSchedule.Sequential)
  ...
  def testPipelineCompare4(self):
    ...
    pipelining_test_util.PipelineTester.compare_pipeline_to_cpu(
        [stage1, stage2, stage3, stage4], inputs_fn, [10.01], repeat_count,
        gradient_accumulation_count, dataset_fn, optimizer_fn, self, 19922,
        True, pipelining_ops.PipelineSchedule.Sequential)
  ...
  def testPipelineCompare5(self):
    ...
    pipelining_test_util.PipelineTester.compare_pipeline_to_cpu(
        [stage1, stage2, stage3, stage4], inputs_fn, [10.01], repeat_count,
        gradient_accumulation_count, dataset_fn, optimizer_fn, self, 8014,
        True, pipelining_ops.PipelineSchedule.Sequential)
