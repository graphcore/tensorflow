...
class FunctionalOpsTest(test_util.TensorFlowTestCase):
  ...
  def testFunctionInferenceWithVariableScope(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_total_tile_memory(1075180)
      report.assert_max_tile_memory(1334)
  ...
  def testFunctionTraining(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_all_compute_sets_and_list(ok)
      report.assert_total_tile_memory(1576162)
      report.assert_max_tile_memory(2744)
  ...
  def testNestedFunctionTraining(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_all_compute_sets_and_list(ok)
      report.assert_total_tile_memory(1522046)
      report.assert_max_tile_memory(2772)
  ...
  def testFunctionSerializedLookup(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_all_compute_sets_and_list(ok)
      report.assert_total_tile_memory(11688302)
      report.assert_max_tile_memory(8480)
  ...
  def testFunctionTrainingConstants(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_all_compute_sets_and_list(ok)
      report.assert_total_tile_memory(1461095)
      report.assert_max_tile_memory(4230)
