...
class FunctionalOpsTest(test_util.TensorFlowTestCase):
  ...
  def testFunctionInferenceWithVariableScope(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_total_tile_memory(945276)
      report.assert_max_tile_memory(1526)
  ...
  def testFunctionTraining(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_all_compute_sets_and_list(ok)
      report.assert_total_tile_memory(1370576)
      report.assert_max_tile_memory(2976)
  ...
  def testNestedFunctionTraining(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_all_compute_sets_and_list(ok)
      report.assert_total_tile_memory(1317440)
      report.assert_max_tile_memory(2984)
  ...
  def testFunctionTrainingConstants(self):
    with tu.ipu_session() as sess:
      ...
      report.assert_all_compute_sets_and_list(ok)
      report.assert_total_tile_memory(1437160)
      report.assert_max_tile_memory(4950)
