...
from tensorflow.python.ipu.config import (IPUConfig, SelectionOrder,
                                          ExecutionProfileType,
                                          DeviceConnectionType,
                                          MergeRemoteBuffersBehaviour,
                                          SchedulingAlgorithm, get_ipu_config,
...
@deprecation.deprecated(
    None,
    "extract_all_strings_from_event_trace is now considered an internal-only"
    " tool and has been moved to"
    " tensorflow.compiler.plugin.poplar.tests.test_utils.py. It will be removed"
    " from this location in a future release.")
...
@deprecation.deprecated(
    None,
    "extract_all_types_from_event_trace is now considered an internal-only"
    " tool and has been moved to"
    " tensorflow.compiler.plugin.poplar.tests.test_utils.py. It will be removed"
    " from this location in a future release.")
...
@deprecation.deprecated(
    None, "extract_all_events is now considered an internal-only"
    " tool and has been moved to"
    " tensorflow.compiler.plugin.poplar.tests.test_utils.py. It will be removed"
    " from this location in a future release.")
