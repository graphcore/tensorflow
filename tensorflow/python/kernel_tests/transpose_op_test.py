...
class TransposeTest(test.TestCase):
  ...
  def testComplex64(self):
    self._testBoth(np.array(np.complex_(1, 2)).astype(np.complex64))
    self._testBoth(np.complex_(1, 2) * np.arange(0, 21).astype(np.complex64))
    self._testBoth(
        np.complex_(1, 2) *
  ...
  def testComplex128(self):
    self._testBoth(np.array(np.complex_(1, 2)).astype(np.complex128))
    self._testBoth(np.complex_(1, 2) * np.arange(0, 21).astype(np.complex128))
    self._testBoth(
        np.complex_(1, 2) *
