...
class GRULayerFwdOp : public GRULayerBaseOp {
 ...
 protected:
  ...
  int64_t InputTensorCount() const override { return 4; }

  int64_t OutputTensorCount() const override { return 1; }
...
class GRULayerBwdOp : public GRULayerBaseOp {
 ...
 protected:
  ...
  int64_t InputTensorCount() const override { return 7; }

  int64_t OutputTensorCount() const override { return 4; }
...
class DynamicGRULayerBwdOp : public GRULayerBwdOp {
 ...
 protected:
  ...
  int64_t InputTensorCount() const override { return 8; }
...
class AUGRULayerBwdOp : public GRULayerBwdOp {
 ...
 protected:
  ...
  int64_t InputTensorCount() const override { return 9; }
