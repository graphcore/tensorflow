...
#ifndef TENSORFLOW_COMPILER_PLUGIN_POPLAR_DRIVER_TOOLS_CUSTOM_OPS_WEIGHTS_TRANSPOSE_CHANS_FLIP_XY_H_
#define TENSORFLOW_COMPILER_PLUGIN_POPLAR_DRIVER_TOOLS_CUSTOM_OPS_WEIGHTS_TRANSPOSE_CHANS_FLIP_XY_H_
...
class HloWeightsTransposeChansFlipXYInstruction : public HloPoplarInstruction {
 public:
...
#endif  // TENSORFLOW_COMPILER_PLUGIN_POPLAR_DRIVER_TOOLS_CUSTOM_OPS_WEIGHTS_TRANSPOSE_CHANS_FLIP_XY_H_
