...
using FeedNameMapping = absl::flat_hash_map<std::string, std::string>;
struct FeedNameMappings {
  FeedNameMapping infeeds;
  FeedNameMapping outfeeds;
};

// Converts infeeds/outfeeds in the provided module into a canonical form and
// returns their mapping to create TranslatedFeedInfos.
StatusOr<FeedNameMappings> CanonicalizeFeedsInModule(HloModule* const module);
}  // namespace poplarplugin
}  // namespace xla
