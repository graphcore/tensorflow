...
static const std::vector<HloMatcherPattern> patterns = {
  ...
  HloMatcherPattern(
    ...
    Pattern({
      ...
      {HloOpcode::kCustomCall, NodeOperands({4, 7, 8, 10}), IsPoplarInstruction(PoplarOp::MultiUpdateAdd)},
      {HloOpcode::kBroadcast, NodeOperands({5})},
      {HloOpcode::kConstant, NodeOperands({}), IsConstantZero},
      {HloMatcherOpcode::kAnyOpcode, NodeOperands({})},
      {HloMatcherOpcode::kAnyOpcode, NodeOperands({})},
  ...
  HloMatcherPattern(
    ...
    Pattern({
      ...
      {HloOpcode::kCustomCall, NodeOperands({5, 8, 9, 11}), IsPoplarInstruction(PoplarOp::MultiUpdateAdd)},
  ...
  HloMatcherPattern(
    ...
    Pattern({
      ...
      {HloOpcode::kMultiply, NodeOperands({3, 2})},
      {HloOpcode::kBroadcast, NodeOperands({9})},
      {HloOpcode::kCustomCall, NodeOperands({4, 7, 8}), IsPoplarInstruction(PoplarOp::MultiUpdate)},
      {HloOpcode::kBroadcast, NodeOperands({5})},
      {HloOpcode::kConstant, NodeOperands({}), IsConstantZero},
      {HloMatcherOpcode::kAnyOpcode, NodeOperands({})},
      {HloMatcherOpcode::kAnyOpcode, NodeOperands({})},
  ...
  HloMatcherPattern(
    ...
    Pattern({
      ...
      {HloOpcode::kMultiply, NodeOperands({4, 3})},
      {HloOpcode::kBroadcast, NodeOperands({10})},
      {HloOpcode::kCustomCall, NodeOperands({5, 8, 9}), IsPoplarInstruction(PoplarOp::MultiUpdate)},
      {HloOpcode::kBroadcast, NodeOperands({6})},
      {HloOpcode::kConstant, NodeOperands({}), IsConstantZero},
      {HloMatcherOpcode::kAnyOpcode, NodeOperands({})},
      {HloMatcherOpcode::kAnyOpcode, NodeOperands({})},
