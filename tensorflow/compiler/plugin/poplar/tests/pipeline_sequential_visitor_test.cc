...
class PipelineSeqVisitorTest : public HloTestBase {};
...
std::unique_ptr<CompilerResources> GetMockResources(
  ...
  auto resources = absl::make_unique<CompilerResources>(
      ...
      false, false, false, merge_infeeds, 1, 0,
      max_inter_ipu_copies_buffer_size, 1, 64, module,
      IpuOptions::FloatingPointBehaviour(), false, "", false, false);
