...
for case in NAMED_GROUP_NORM_TESTCASES:
  # Add a channel_strided_input=True variant case.
  new_case = dict(case)
  new_case["testcase_name"] = new_case["testcase_name"] + "_scg"
  new_case["channel_strided_input"] = False
  new_cases += (new_case,)
