...
_pop_op_serialized_gradient_accumulation_1 {
  ...
  a0 = f32[128] add(p0, p1)
  ROOT a1 = f32[128] add(a0, p2)
}

stage_0_fwd {
  stage_0_fwd_p0 = f32[128] parameter(0)
  l = f32[128] log(stage_0_fwd_p0)
  ROOT stage_0_fwd_tuple = (f32[128]) tuple(l)
}

stage_1_fwd {
  stage_1_fwd_p0 = f32[128] parameter(0)
  l = f32[128] log(stage_1_fwd_p0)
  ROOT stage_1_fwd_tuple = (f32[128]) tuple(l)
}

stage_2_fwd {
  stage_2_fwd_p0 = f32[128] parameter(0)
  l = f32[128] log(stage_2_fwd_p0)
  ROOT stage_2_fwd_tuple = (f32[128]) tuple(l)
}

stage_2_bwd {
  stage_2_bwd_p0 = f32[128] parameter(0)
  stage_2_bwd_p1 = f32[128] parameter(1)
  add = f32[128] add(stage_2_bwd_p0, stage_2_bwd_p1)
  ROOT stage_2_bwd_tuple = (f32[128]) tuple(add)
}

stage_1_bwd {
  stage_1_bwd_p0 = f32[128] parameter(0)
  stage_1_bwd_p1 = f32[128] parameter(1)
  stage_1_bwd_accumulator = f32[128] parameter(2)
  ROOT stage_1_bwd_tuple = (f32[128], f32[128], f32[128]) tuple(stage_1_bwd_p0, stage_1_bwd_p1, stage_1_bwd_accumulator)
}

stage_0_bwd {
  stage_0_bwd_p0 = f32[128] parameter(0)
  stage_0_bwd_p1 = f32[128] parameter(1)
...
resource_update {
  ...
  ROOT t = (f32[128]) tuple(a0)
}

pipeline {
  pipeline_p0 = f32[128] parameter(0), sharding={maximal device=0}
  pipeline_stage_0 = (f32[128]) call(pipeline_p0), to_apply=stage_0_fwd, backend_config="{\"callConfig\":{\"type\":\"PipelineStage\",\"pipelineStageConfig\":{\"stageId\":\"0\"}}}", sharding={maximal device=0}
  pipeline_stage_0.0 = f32[128] get-tuple-element(pipeline_stage_0), index=0

  pipeline_stage_1 = (f32[128]) call(pipeline_stage_0.0), to_apply=stage_1_fwd, backend_config="{\"callConfig\":{\"type\":\"PipelineStage\",\"pipelineStageConfig\":{\"stageId\":\"1\"}}}", sharding={maximal device=0}
  pipeline_stage_1.0 = f32[128] get-tuple-element(pipeline_stage_1), index=0

  pipeline_stage_2 = (f32[128]) call(pipeline_stage_1.0), to_apply=stage_2_fwd, backend_config="{\"callConfig\":{\"type\":\"PipelineStage\",\"pipelineStageConfig\":{\"stageId\":\"2\"}}}", sharding={maximal device=0}
  pipeline_stage_2.0 = f32[128] get-tuple-element(pipeline_stage_2), index=0

  pipeline_stage_2_bwd = (f32[128]) call(pipeline_stage_2.0, pipeline_stage_1.0), to_apply=stage_2_bwd, backend_config="{\"callConfig\":{\"type\":\"PipelineStageBackward\",\"pipelineStageConfig\":{\"stageId\":\"2\"}}}"
  pipeline_stage_2_bwd.0 = f32[128] get-tuple-element(pipeline_stage_2_bwd), index=0

  pipeline_accumulator_1 = f32[128] custom-call(pipeline_p0), custom_call_target="GradientAccumulatorCreate"
  pipeline_stage_1_bwd = (f32[128], f32[128], f32[128]) call(pipeline_stage_2_bwd.0, pipeline_stage_1.0, pipeline_accumulator_1), to_apply=stage_1_bwd, backend_config="{\"callConfig\":{\"type\":\"PipelineStageBackward\",\"pipelineStageConfig\":{\"stageId\":\"1\"}}}"
  pipeline_stage_1_bwd.0 = f32[128] get-tuple-element(pipeline_stage_1_bwd), index=0
  pipeline_stage_1_bwd.1 = f32[128] get-tuple-element(pipeline_stage_1_bwd), index=1
  ...
  call_ru = (f32[128]) call(pipeline_accumulator_0_sink, pipeline_accumulator_1_sink), to_apply=resource_update, frontend_attributes={CALL_CONFIG_TYPE=ResourceUpdate}, backend_config="{\"callConfig\":{\"type\":\"ResourceUpdate\"}}"
  pipeline_p0_updated = f32[128] get-tuple-element(call_ru), index=0
  ROOT pipeline_tuple = (f32[128]) tuple(pipeline_p0_updated)
}

ENTRY e {
  e.weights0 = f32[128] parameter(0), parameter_replication={false}
  ROOT e.call = (f32[128]) call(e.weights0), to_apply=pipeline, backend_config="{\"callConfig\":{\"type\":\"Pipeline\", \"pipelineConfig\":{\"schedule\":%d,\"batch_serialization_iterations\":5,\"offload_gradient_accumulation_buffers\":\"%s\"}}}"
}
)";
