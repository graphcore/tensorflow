...
ENTRY main {
  ...
  update = f32[100,16] custom-call(input, concat_offsets, concat_updates, lr), custom_call_target="Popops::MultiUpdateAdd", backend_config="{\"index_vector_dim\":1,\"update_dim\":1}\n"
