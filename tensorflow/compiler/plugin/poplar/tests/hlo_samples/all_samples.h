...
#ifndef TENSORFLOW_COMPILER_PLUGIN_POPLAR_TESTS_HLO_SAMPLES_ALL_SAMPLES_H_
...
#include "tensorflow/compiler/plugin/poplar/tests/hlo_samples/serialized_matmul_hlo.h"

#endif  // TENSORFLOW_COMPILER_PLUGIN_POPLAR_TESTS_HLO_SAMPLES_ALL_SAMPLES_H_
