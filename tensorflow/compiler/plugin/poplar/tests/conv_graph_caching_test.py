...
class ConvGraphCachingTest(xla_test.XLATestCase):
  ...
  def testConvolutionsMatchFwdBwdWu(self):
    with self.session() as sess:
      ...
      ok = [
          ...
          'gradients/vs/conv1/Conv2D_grad/Conv2DBackpropFilter/fusion.*/cast',
  ...
  def testConvolutionsMatchFwdBwdWuVariableLR(self):
    with self.session() as sess:
      ...
      ok = [
          ...
          'gradients/vs/conv*/Conv2D_grad/Conv2DBackpropFilter/fusion.*/cast',
  ...
  def testConvolutionsWithBroadcast(self):
    with self.session() as sess:
      ...
      report.assert_max_tile_memory_in_range(10000, 20000)
