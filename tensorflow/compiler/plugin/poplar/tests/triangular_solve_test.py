...
class TriangularSolvePerformanceTest(xla_test.XLATestCase):
  ...
  def testLowerAdjoint(self):
    ...
    self.assert_max_tile_memory(report, 27262, tolerance=0.1)
    self.assert_total_tile_memory(report, 100356, tolerance=0.1)
  ...
  def testLowerNonAdjoint(self):
    ...
    self.assert_max_tile_memory(report, 30467, tolerance=0.1)
    self.assert_total_tile_memory(report, 110400, tolerance=0.1)
  ...
  def testUpperAdjoint(self):
    ...
    self.assert_max_tile_memory(report, 31850, tolerance=0.1)
    self.assert_total_tile_memory(report, 117186, tolerance=0.1)
  ...
  def testUpperNonAdjoint(self):
    ...
    self.assert_max_tile_memory(report, 29945, tolerance=0.1)
    self.assert_total_tile_memory(report, 109556, tolerance=0.1)
