...
template <typename HostEmbeddingImpl>
...
#define REGISTER_HOST_EMBEDDING_SGD_REGISTER_KERNEL(T)             \
  REGISTER_KERNEL_BUILDER(Name("IpuHostEmbeddingRegister")         \
                              .Device(DEVICE_CPU)                  \
                              .TypeConstraint<T>("T")              \
                              .AttrConstraint("optimizer", "SGD"), \
                          IpuHostEmbeddingRegisterOp<HostEmbeddingSGD<T>>);

TF_CALL_half(REGISTER_HOST_EMBEDDING_SGD_REGISTER_KERNEL);
TF_CALL_float(REGISTER_HOST_EMBEDDING_SGD_REGISTER_KERNEL);
TF_CALL_int32(REGISTER_HOST_EMBEDDING_SGD_REGISTER_KERNEL);
TF_CALL_uint32(REGISTER_HOST_EMBEDDING_SGD_REGISTER_KERNEL);

#define REGISTER_HOST_EMBEDDING_SGDACC_REGISTER_KERNEL(T)             \
  REGISTER_KERNEL_BUILDER(Name("IpuHostEmbeddingRegister")            \
                              .Device(DEVICE_CPU)                     \
                              .TypeConstraint<T>("T")                 \
                              .AttrConstraint("optimizer", "SGD+GA"), \
                          IpuHostEmbeddingRegisterOp<HostEmbeddingSGDAcc<T>>);

TF_CALL_half(REGISTER_HOST_EMBEDDING_SGDACC_REGISTER_KERNEL);
TF_CALL_float(REGISTER_HOST_EMBEDDING_SGDACC_REGISTER_KERNEL);
TF_CALL_int32(REGISTER_HOST_EMBEDDING_SGDACC_REGISTER_KERNEL);
TF_CALL_uint32(REGISTER_HOST_EMBEDDING_SGDACC_REGISTER_KERNEL);
