 ...
 public:
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    xla::Shape output_tuple_shape = xla::ShapeUtil::MakeTupleShape(
        {output_seq_shape, output_state_shape, intermediates_shape});
    ...
    xla::XlaOp intermediates = xla::GetTupleElement(output_tuple, 2);
