...
<https://docs.graphcore.ai/projects/poplar-user-guide/>`_ and the :tutorials-repo:`Poplar tutorials <tutorials/poplar>` on the Graphcore GitHub tutorials repository.
...
<https://docs.graphcore.ai/projects/poplar-api/en/latest/poplar/graph/VariableMappingMethod.html>`__
